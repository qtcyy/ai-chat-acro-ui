...
import { useHistory, ChatType } from "../hooks/useHistory";
...
const ChatHistory = () => {
  ...
  const [displayChats, setDisplayChats] = useState<ChatType[]>(chats);
  ...
  // 订阅过滤后的聊天列表
  useEffect(() => {
    const subscription: Subscription = filteredChats$.subscribe({
      next: (filteredChats) => {
