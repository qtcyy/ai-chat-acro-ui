...
`,C=()=>{let e=(0,a.s0)(),t=(0,n.z)(),{setChatLoadSignal:r,chatLoadSignal:c}=(0,g.o)(),{isDarkMode:s}=(0,x.F)(),[l,y]=(0,i.useState)(""),[C,Z]=(0,i.useState)([]);(0,i.useEffect)(()=>{r(c+1),null==t||t.sortByTime()},[]),(0,i.useEffect)(()=>{Z((null==t?void 0:t.chats)??[])},[null==t?void 0:t.chats]),(0,i.useEffect)(()=>{I()},[l]);let k=async()=>{if(!l.trim()){Z((null==t?void 0:t.chats)??[]);return}Z(e=>e.filter(e=>e.name.toLowerCase().includes(l.toLowerCase())))},{runAsync:I,loading:E}=(0,v.Z)(k,{debounceWait:300,manual:!0}),D=t=>{e(`/ai/chat/page/${t}`)},J=async(e,r)=>{e.stopPropagation();let o=await f.ZP.show(p.t,{chat:r});if("string"!=typeof o){console.error("type error");return}console.log(o),null==t||t.updateChat(e=>{let t=e.findIndex(e=>e.chatId===r.chatId);return e[t].name=o,[...e]})},T=async(e,r)=>{e.stopPropagation(),await f.ZP.show(m.p)&&(null==t||t.removeChat(r))};return(0,o.jsxs)(w,{children:[(0,o.jsx)("div",{className:" flex flex-col",children:(0,o.jsx)("div",{className:"text-4xl font-bold mt-10 text-center",children:"历史会话"})}),(0,o.jsxs)(P,{children:[(0,o.jsx)(N,{children:(0,o.jsx)(d.Z,{})}),(0,o.jsx)(S,{placeholder:"搜索历史会话",value:l,onChange:e=>y(e.target.value)})]}),(0,o.jsx)(b.Z,{loading:E,children:(0,o.jsx)("div",{className:"flex flex-col items-center gap-3 mt-[70px]",children:C.map(e=>(0,o.jsxs)(j,{className:"group",onClick:()=>D(e.chatId),whileHover:{scale:1.1},whileTap:{scale:.9},drag:!0,dragConstraints:{left:0,right:300},dragElastic:.2,dragMomentum:!0,children:[(0,o.jsx)("div",{className:"max-w-[80%]",children:e.name}),(0,o.jsx)("div",{className:"ml-auto text-sm group-hover:hidden",children:O(e.updateTime)}),(0,o.jsxs)("div",{className:"hidden group-hover:flex ml-auto flex-row gap-2",children:[(0,o.jsx)("div",{className:`px-1  ${s?"bg-gray-700 hover:bg-gray-500":"bg-gray-200 hover:bg-gray-200"} rounded-md`,onClick:t=>J(t,e),children:(0,o.jsx)(u.Z,{})}),(0,o.jsx)("div",{className:"px-1 bg-red-200 text-red-600 rounded-md",onClick:t=>T(t,e.chatId),children:(0,o.jsx)(h.Z,{})})]})]},e.chatId))})})]})}},82297:function(e,t,r){r.d(t,{t:()=>p});var o=r(2596),a=r(8007),n=r(80233),c=r(79843),i=r(3390),s=r(62024),l=r(21543),d=r(53753),u=r(18223),h=r(81648);let f=s.ZP.div`
  display: flex;
  flex-direction: row;
  gap: 12px;
  color: ${e=>e.theme.colors.text};
`,p=i.ZP.create(e=>{let{chat:t}=e,r=i.ZP.useModal(),[c,s]=(0,l.useState)(t.name),[p,y]=(0,l.useState)(!1),[g,x]=(0,l.useState)(!1),{isDarkMode:v,theme:b}=(0,h.F)(),{getName:w}=(0,d.U)({messages:t.content,body:{model:"qwen-omni-turbo"}}),j=()=>{r.hide(),setTimeout(()=>{r.remove()},300)},O=async()=>{if(""!==c){x(!0);try{let e=await u.WY.post("/api/chat/history/update/name",{id:t.chatId,name:c});if(200!==e.data.code)throw Error(e.data.msg);r.resolve(c),j()}catch(e){console.error(e)}finally{x(!1)}}},P=e=>{e.preventDefault(),e.target.select()},N=async()=>{y(!0);try{let e=await w();s(e),console.log(e)}catch(e){console.error("命名错误： ",e)}finally{y(!1)}};return(0,o.jsx)(a.Z,{visible:r.visible,onCancel:j,onConfirm:O,title:(0,o.jsx)("div",{style:{color:b.colors.text},children:"重命名对话"}),style:{background:b.colors.background},children:(0,o.jsxs)(f,{children:[(0,o.jsx)(m,{value:c,onChange:e=>s(e),placeholder:"请输入名称...",onFocus:e=>P(e),allowClear:!0}),(0,o.jsx)(n.Z,{loading:p,onClick:N,children:"智能命名"})]})})}),m=(0,s.ZP)(c.Z)`
